...
<table style="width:500px;">
    ...
    <tr>
        <td>
            알고리즘을 짜는 방법을 키울 수 있었으며, 프로그램을 처음부터 기획하는 방법을 알 수 있었습니다. 컬렉션 중 ArrayList와 HashMap을 사용해서 더미를 만들고 이를 이용해 구현하는 점             에서 어려움이 있었지만, 프로젝트를 통해서 실력을 향상시킬 수 있었습니다. 파일에 수강, 회원, 관리자 정보에서 연관성을 생각하여 파일을 업데이트하는 걸 완벽하게 구현을 하지 못             했던게 아쉬웠습니다. 
        </td>
    </tr>
</table>
